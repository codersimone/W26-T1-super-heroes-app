...
import SuperHeroe from './components/SuperHeroes';

const arraySuperHeroesJSON = `[{
...
function App() {
    return (
        <div className='App'>
        {superHeroesBase.map((heroesId) =>
            <><SuperHeroe superHeroePic={heroesId.superHeroePic} superHeroeCharacter={heroesId.superHeroeCharacter} comicsUniverse={heroesId.comicsUniverse} alterEgo={heroesId.alterEgo} typeOfActivity={heroesId.typeOfActivity} friends={heroesId.friends} superPowers={heroesId.superPowers} moreDetailed={heroesId.moreDetailed}></SuperHeroe></>
            )
        }
        </div>
    );
